...
class RescheduleBookingBottomSheet extends StatefulWidget {
  const RescheduleBookingBottomSheet({super.key});

  @override
  _RescheduleBookingBottomSheetState createState() =>
      _RescheduleBookingBottomSheetState();
}

class _RescheduleBookingBottomSheetState
    extends State<RescheduleBookingBottomSheet> {
  ...
  void _onReschedule() {
    ...
    solutionCareController.bookingRescheduleAppointment();
  }
}
