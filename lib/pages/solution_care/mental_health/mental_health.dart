          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  "Connect with therapists, support groups, and resources to improve mental well-being.",
                  style: GoogleFonts.plusJakartaSans(
                    fontWeight: FontWeight.w600,
                    fontSize: 12,
                              ...
                              children: [
                                ...
                                Row(
                                  children: [
                                    ...
                                    Flexible(
                                      child: Text(
                                        "Group support sessions for stress and anxiety management",
                                        style: GoogleFonts.plusJakartaSans(
                                          fontSize: 14,
                                          color: AppColors.textGrey,
                                        ),
                              ...
                              children: [
                                ...
                                Row(
                                  ...
                                  children: [
                                    ...
                                    Flexible(
                                      child: Text(
                                        "Choose your preferred support type (e.g., Therapy, Support Group)",
                                        style: GoogleFonts.plusJakartaSans(
                                          fontSize: 14,
                                          color: AppColors.textGrey,
                                        ),
                                ...
                                Row(
                                  children: [
                                    ...
                                    Flexible(
                                      child: Text(
                                        "Confirm your location for the session",
                                        style: GoogleFonts.plusJakartaSans(
                                          fontSize: 14,
                                          color: AppColors.textGrey,
                                        ),
